...
const Seguros = () => {
  ...
  useEffect(() => {
    if (tipo) setServicios(dataSecure[parseInt(tipo as string)])
  }, [tipo])

  return (
    <div className="bg-black w-full mx-auto ">
      <div className="text-center pt-5 lg:w-full md:w-[80%] lg:text-sm xl:text-base mx-2 md:mx-auto  ">
        <button
      ...
      <div
        className={`${
         ...
         first-letter:h-full w-full container mx-auto`}
      >
        <SeguroPersonas />
      </div>
      <div
